    ...
    return [
      {
        ...
        headers: [
          ...
          // Content-Security-Policy básica (puede requerir ajustes según uso de scripts externos)
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://connect.facebook.net https://graph.facebook.com https://vercel.live; connect-src 'self' https://graph.facebook.com https://vercel.live; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:;",
          }
        ],
      },
    ];
